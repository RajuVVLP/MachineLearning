...
#random_state tell the algorithm to use same data sample. This avoids confusion when QA/UAT is performing the validation.
...
#Pass the values in range format
lr_grid = {'C':list(np.arange(0.1,1.0,0.1)), 'penalty':['l1','l2'], 'max_iter':list(range(100,1000,200))}

#Passing the values using list fashion (Alternate way)
lr_grid = {'C':[0.2,0.5,0.7,1], 'penalty':['l1','l2'], 'max_iter':[100, 150, 200]}
