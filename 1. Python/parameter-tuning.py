...
#Lambda is like a for loop used for only one line of logics
titanic_train.apply(lambda x : sum(x.isnull())) #Get me the count where the data/column isnull
...
#n_jobs means: Use systems cores
