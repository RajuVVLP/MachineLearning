...
#Heat map is to understand the correlation between columsns/fetures
#Heat map can be apploed on only on numberv columns
...
features = ['livarea', 'BsmtUnfSF','1stFlrSF', '2ndFlrSF']
