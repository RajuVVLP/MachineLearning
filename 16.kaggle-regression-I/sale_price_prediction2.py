...
#Normally we don't convert numneric to categoric. But in this case we have to do it as the system understand different way  being it is numbers.
#And then we have to do one hot encoding back..          
...
to_delete  #This shows how many missing values are there. This is better way than describe/info()
