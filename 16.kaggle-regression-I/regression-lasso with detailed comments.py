...
grid_lasso_estimator = model_selection.GridSearchCV(lasso_estimator,lasso_grid,scoring=metrics.make_scorer(rmse),cv=10)
...
test['SalePrice'] = grid_lasso_estimator.predict(X_test)
